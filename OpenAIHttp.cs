...
{
    public class OpenAIHttp : IOpenAIHttp
    {
       protected static HttpClient httpClient;
        ...
        public async Task<ResponseData> SendMsg<RequestData, ResponseData>(RequestData data, string url) where RequestData : class, new() where ResponseData : class, new()
        {
            try
            {
        ...
        public async Task<ResponseData> SendMsg<ResponseData>(string url, string data) where ResponseData : class, new()
        {
            try
            {
        ...
        public async Task<ResponseData> GetdMsg<ResponseData>(string url) where ResponseData : class, new()
        {
            try
            {
        ...
        public async Task<ResponseData> Delete<ResponseData>(string url) where ResponseData : class, new()
        {
            try
            {
